...
- **Value:** Approximately $680–730 billion/year (2024 est.), i.e., the retail line + provider-administered drugs embedded within hospital and physician/clinical-services NHE categories, estimated at an additional 4–5% of total NHE (~$212–264B on a $5.28T base). **Code review (R214): the $680–730B endpoints above are as originally published and are NOT re-derived from CP-RX-001's owned line.** They were built on the $467.0B 2024 retail figure that CP-RX-001's reconciliation note sets aside; substituting the owned line ($449.7B 2023, $461.4B in real 2024 dollars) gives $673–725B instead. The range is retained as the externally published estimate it is, at Medium confidence, and the model's $717.9B base sits inside it either way. **A direct CMS pull would settle the retail term and the range together.**
...
| CP-RX-006 | $98.5B/10yr (negotiation-specific); $237B/10yr (full IRA drug package), **as originally scored** | CBO-scored real-world precedent for govt negotiation savings. R34: CBO's 2025 re-scoring revised the projected deficit reduction downward, so this is a precedent and not the IRA's current standing. |
