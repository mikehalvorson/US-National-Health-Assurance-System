...
- **RECONCILIATION (R214, R296):** This value and its growth rate are not mutually consistent with the 2023 CMS table in `research/01_macro_financing_population_offsets.md`, which records retail prescription drugs at **$449.7 billion (2023)**. $467.0B at 7.9% above 2023 implies a 2023 base of **$432.8 billion**, $16.9 billion below the 2023 line. Holding $449.7B fixed, 7.9% growth implies a 2024 retail total near **$485 billion**; holding $467.0B fixed, the implied growth is **3.85%**, not 7.9%. The two cannot both describe the same CMS account.
  - The same 2024 NHE table is internally inconsistent on a second line in the same way. RB-03-DX-001 records physician & clinical services at **$1.11 trillion (2024)**, described as having *"grew 8.1%"*, against **$978.0 billion (2023)** in `research/01`. That is 13.5% growth, not 8.1%. 8.1% applied to the 2023 NHE total of $4,866.5 billion gives $5,261 billion, which is the **$5.28 trillion** total the same entry reports, so the 8.1% appears to be the NHE total's growth rate attached to a category line.
  - RB-03-DX-001's own source note records that the CMS Highlights PDF *"returned HTTP 403 on direct fetch during this research pass"* and that its figures are *"drawn from search-result excerpts."* It already asks for a human re-pull. The 2023 table in `research/01` was read whole.
...
### RB-03-RX-002 - Total U.S. drug spending INCLUDING hospital/clinic-administered drugs
- **Value:** Approximately $680–730 billion/year (2024 est.), i.e., the retail line + provider-administered drugs embedded within hospital and physician/clinical-services NHE categories, estimated at an additional 4–5% of total NHE (~$212–264B on a $5.28T base). **Code review (R214): the $680–730B endpoints above are as originally published and are NOT re-derived from RB-03-RX-001's owned line.** They were built on the $467.0B 2024 retail figure that RB-03-RX-001's reconciliation note sets aside; substituting the owned line ($449.7B 2023, $461.4B in real 2024 dollars) gives $673–725B instead. The range is retained as the externally published estimate it is, at Medium confidence, and the model's $717.9B base sits inside it either way. **A direct CMS pull would settle the retail term and the range together.**
...
### RB-03-RX-003 - U.S. vs. international drug price comparison (RAND gold standard)
...
### RB-03-RX-004 - Insulin-specific international price gap
...
### RB-03-RX-005 - PBM spread pricing (FTC)
...
### RB-03-RX-006 - CBO score: Medicare drug price negotiation (IRA) savings
- **Value (R34: original scores. CBO re-scoring in 2025 revised the projected deficit reduction downward; see the Confidence line):** CBO originally estimated **$98.5 billion** in direct Medicare program savings over 10 years (2022–2031) from the negotiation provision itself; the broader package of IRA drug-pricing provisions (negotiation + inflation rebates + Part D redesign) was estimated to reduce the federal deficit by **$237 billion** over 10 years (2022–2031), of which ~$160B tied to Part D/pricing-limit redesign elements. CBO separately projects negotiated ("maximum fair price") prices will reduce **net prices for the selected drugs by ~50% on average**, though because negotiated drugs are a minority of total Part D spend, aggregate net-price reduction across all Medicare drug spending is much smaller than 50%.
...
### RB-03-RX-007 - First-round (2026) negotiated price discounts, realized examples
...
### RB-03-RX-008 - Insulin: U.S. price vs. cost of production (Yale/BMJ Global Health)
...
### RB-03-RX-009 - Real-world public/nonprofit insulin pricing precedent
...
### RB-03-RX-010 - Generic drug market share and savings
...
### RB-03-RX-011 - Civica Rx: model mechanics and scale
...
### RB-03-RX-012 - Rebate structure / formulary exclusion dynamics (context, not a hard number)
...
### RB-03-RX-014 [NEW PARAMETER] - Hospital markup on physician-administered drugs (340B/buy-and-bill context)
...
### RB-03-RX-015 [NEW PARAMETER] - Overall hospital commercial-to-Medicare price ratio (facility services, all types incl. imaging/drugs)
...
### RB-03-DX-002 - U.S. medical device market size
...
### RB-03-DX-003 - Common lab test pricing: Medicare CLFS rate vs. average billed charge
- **Value:**
...
### RB-03-DX-005 - Imaging: commercial-vs-Medicare price ratio, by study type
...
- **Confidence:** High - peer-reviewed, claims-based studies using price-transparency data, consistent with RAND's broader hospital-pricing findings (RB-03-RX-015).

### RB-03-DX-006 - Medicare Physician Fee Schedule: specific imaging payment amounts
...
### RB-03-DX-007 - Low-value care / duplicate testing spending estimates
...
### RB-03-DX-008 - Group Purchasing Organization (GPO) device/supply savings
...
### RB-03-DX-009 [NEW PARAMETER] - Direct-to-consumer/cash lab pricing floor (useful "marginal cost" proxy)
...
### RB-03-DX-010 [NEW PARAMETER] - Dental spending as a distinct NHE category
...
### RB-03-DX-011 [NEW PARAMETER] - Hospital outpatient/inpatient markup baseline for imaging & labs (reuse of RB-03-RX-015)
- Cross-reference RB-03-RX-015 above (RAND 5.1: commercial pays 254% of Medicare inpatient, 279% of Medicare outpatient, on average, 2022 data) - this is the single most load-bearing "how much would prices fall if everyone paid Medicare-equivalent rates" parameter and applies directly to imaging, labs, and device-embedded procedures, not just drugs. Recommend the simulation use this as its primary "commercial-to-Medicare conversion multiplier" for the diagnostics/imaging/device cost module, with the 2.2x-5.9x modality-specific range (RB-03-DX-005) as a more granular alternative for imaging specifically.
...
| Param | Value | Use |
|---|---|---|
| RB-03-RX-001 | $449.7B (2023), `params.ts` `BASE2023.rxRetail` | Retail drug spend baseline. The $467.0B (2024) figure originally recorded here does not reconcile with it and is not used; see the reconciliation note under RB-03-RX-001. |
| RB-03-RX-003 | 2.78x (avg), 4.22x (brand) | Int'l price gap for negotiation-savings modeling |
| RB-03-RX-006 | $98.5B/10yr (negotiation-specific); $237B/10yr (full IRA drug package), **as originally scored** | CBO-scored real-world precedent for govt negotiation savings. R34: CBO's 2025 re-scoring revised the projected deficit reduction downward, so this is a precedent and not the IRA's current standing. |
| RB-03-RX-008/009 | $2.28-6.16/vial production cost; $30/vial Civica real-world price | Public Medicines Corp calibration |
| RB-03-RX-010 | 90% volume / 12-13% spend on generics | Generic baseline, already-efficient segment |
| RB-03-RX-015 / RB-03-DX-011 | Commercial = 254-279% of Medicare | Master "move-to-Medicare-rates" savings multiplier |
| RB-03-DX-001 | $5.28T total NHE 2024; $1.63T hospital; $1.11T physician/clinical | Top-line sizing |
| RB-03-DX-007 | $75.7-101.2B/yr low-value care; $760-935B/yr total system waste | Waste-reduction savings ceiling |
| RB-03-DX-008 | 10-18% per-contract GPO savings (more defensible than $34-55B/yr aggregate) | Device procurement savings |

## Explicit Data Gaps / Follow-Up Recommended
1. **RB-03-DX-001**: Exact CMS NHE Table 2 dollar splits for "durable medical equipment," "other non-durable medical products," and "other professional services" could not be pulled directly (cms.gov blocked automated PDF fetch with HTTP 403 in this session). A human or browser-based agent should retrieve these directly from https://www.cms.gov/data-research/statistics-trends-and-reports/national-health-expenditure-data (NHE Tables, historical zip/Excel files) for precision.
...
2. **RB-03-RX-012**: No authoritative national total for PBM rebate dollars retained (vs. passed through) was found; FTC reports describe mechanism, not a national dollar total. Model as a sensitivity band (0-20% retention) rather than a point estimate.
3. **RB-03-RX-013**: Big-3 PBM combined market share (~80% commonly cited) was not independently re-verified this pass; confirm before use.
4. **RB-03-DX-006**: Precise current Medicare-allowed (not beneficiary-cost-share) national average payment amounts for standard CPT codes (brain MRI 70551/70553, abdomen/pelvis CT 74177, chest X-ray 71046) should be pulled directly from the CMS Physician Fee Schedule Look-Up Tool for simulation-grade precision rather than the secondary-source figures cited here.
