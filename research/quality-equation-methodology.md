...
| 8.0% baseline uninsured share | KPP-A1 | Census CPS ASEC all-ages uninsured rate, 2024. **Not** derived as 26.7M / 334M: that division lands on 8.0% but pairs KFF's under-65 count with an all-ages population, and the two measures are not comparable (`BL-0015` and `BL-0016`) | medium-high |
