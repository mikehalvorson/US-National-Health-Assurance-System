...
export const LTC_WORKFORCE = {
  ...
  /* R284 [§S9d]: the only two figures in this block that are not measured.
     Everything else here is PHI 2025 on BLS data; these are assumptions the
     plan makes. Their grade and their justification live in ltc.ts's
     PLANNING_INPUTS, not here: this module owns the numbers, the chapter owns
     how they are presented, and the first fix run put four parallel
     Basis/Confidence fields on a flat object of bare numbers instead. */
